...
public abstract class YTBaseActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private TextView tvPublishedDate, tvVideoTitle,tvCollapsedVideoTitle, tvVideoViews, tvVideoLikes, tvVideoDisLikes, tvVideoDescription;
    ...
    private void init() {
        if (playerView == null) {
            ...
            YTPlayerTextView.applyFont(tvPublishedDate, tvVideoTitle,tvCollapsedVideoTitle, tvVideoViews, tvVideoLikes, tvVideoDisLikes, tvVideoDescription);
        }
    }
